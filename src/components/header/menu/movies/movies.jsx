...
export const Movies = ({movie}) => {
  ...
  useEffect(() => {
    const fetchPopular = async () => {
      const BASE_URL = 'https://api.themoviedb.org/3/movie/popular?api_key=3f1fcf681379c251b20684e64bad92df&language=en-US&page='
  ...
  return (
    <section className="movies">
      ...
      <Stack spacing={2}>
        {!!page && (
          <Pagination sx={{padding: '15px', marginX:'auto'}}
          count={totalPage}
          page={page}
